...
Friend Class frmAbout
	...
	Private Sub frmAbout_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		'Me.Icon = Lib_GetFromImageList(101, vbResIcon)
        '2.0.0 Me.Icon = Lib_GetMainIcon
        ...
        '2.0.0 picIcon.Image = Lib_GetMainIcon
        'picIcon.Picture = Lib_GetFromImageList(101, vbResBitmap)
